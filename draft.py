...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        Label(self.top_frame,text="Seg2 Tape",fg='yellow',bg='red',font=('Courier',44)).pack()
        self.bottom_frame=Frame(self,width=1500,height=100)
        self.bottom_frame.grid(row=17,column=0,columnspan=20,rowspan=5)
        self.top_frame.grid(row=0,column=0,columnspan=200,rowspan=4)
        ...
        self.type_combo=Entry(self,highlightthickness=3)
        ...
        Button(self,text="seg2 tape",command=lambda : self.showOutput(self.inputfile.get(),self.record.get(),self.sample.get(),self.log.get(),self.type_combo.get(),self.device_combo.get()),bg='yellow',fg='black',font=('Courier',11,'bold')).grid(row=17,column=6)
        Button(self,text='Clear',command=self.clear2,bg='yellow',fg='black',font=('Courier',11,'bold')).grid(row=18, column=6)
